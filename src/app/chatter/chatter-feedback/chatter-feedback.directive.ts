...
export default function ChatterFeedbackDirective(TopicApi, BIGate) {
    ...
    var moduleStyle;
    var canvasAttr;
    var _top, _left, _bottom, _right;
    var rect: any;
    var drag: boolean;
    var highlight: Number = 1;
    var post: any;
    var dtype: String;
    var ignore: any;
    var _canvas: JQuery;
            ...
            (function ($) {
                ...
                $.feedback = function (options) {
                    ...
                    var settings = $.extend({
                        ...
                        feedbackButton: '.bic-feedback-launcher-button',
                    ...
                    var _html2canvas = true; //Girish updated to true to avoid loading the script again as it will be loaded by webpack
                    if (supportedBrowser) {
                        ...
                        $(document).on('click', settings.feedbackButton, function () {
                            ...
                            $('#feedback-canvas').css('z-index', '30000').attr(canvasAttr); //Girish
                            ...
                            var ctxElem = <HTMLCanvasElement>$('#feedback-canvas')[0];
                            ...
                            if (settings.highlightElement) {
                                ...
                                $(document).on('mousemove click', '#feedback-canvas', function (e) {//Girish removed mousemove
                                    if (canDraw) {
                                        redraw(ctx, null);
                                        tmpHighlighted = [];
                                        ...
                                        // $('* :not(body,script,iframe,div,section,.feedback-btn,#DashboardPageContentDiv,#feedback-module *)').each(function(){
                    ...
                    function close() {
                        ...
                        $(document).off('selectstart dragstart');//Girish
